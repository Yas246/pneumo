    ...
    <View style={baseStyles.section}>
      ...
      {smoking && Object.values(smoking).some((v) => hasValue(v)) && (
        <>
          ...
          <View style={baseStyles.grid}>
            ...
            <View style={baseStyles.gridItem}>
              <PDFField label="PA (paquet-années)" value={smoking?.packYears} />
            </View>
            <View style={baseStyles.gridItem}>
        ...
        Object.values(longTermMedication).some((v) => hasValue(v)) && (
          <>
            ...
            <View style={baseStyles.grid}>
              ...
              <View style={baseStyles.gridItem}>
                <PDFField label="Durée" value={longTermMedication?.duration} />
              </View>
            </View>
          </>
        )}
      ...
      {medicinalPlants &&
        Object.values(medicinalPlants).some((v) => hasValue(v)) && (
          <>
            <Text style={baseStyles.subsectionTitle}>Plantes médicinales</Text>
            <View style={baseStyles.grid}>
              <View style={baseStyles.gridItem}>
                <PDFField label="Présentes" value={medicinalPlants?.present} />
              </View>
              <View style={baseStyles.gridItemFull}>
    ...
    <View style={baseStyles.section}>
      ...
      {chronicBronchitis &&
        Object.values(chronicBronchitis).some((v) => hasValue(v)) && (
          <>
            <Text style={baseStyles.subsectionTitle}>Bronchite chronique</Text>
            <View style={baseStyles.grid}>
              <View style={baseStyles.gridItem}>
                <PDFField label="Présente" value={chronicBronchitis?.present} />
              </View>
              <View style={baseStyles.gridItem}>
                <PDFField label="Détails" value={chronicBronchitis?.details} />
              </View>
              <View style={baseStyles.gridItem}>
      ...
      <View style={baseStyles.grid}>
        ...
        <View style={baseStyles.gridItem}>
          <PDFField
            label="HTA"
            value={
              (medicalHistory?.hypertension as Record<string, unknown>)?.present
            }
          />
        </View>
        <View style={baseStyles.gridItem}>
          <PDFField
            label="Détails HTA"
            value={
              (medicalHistory?.hypertension as Record<string, unknown>)?.details
            }
          />
        </View>
        <View style={baseStyles.gridItem}>
          <PDFField
            label="Cardiopathie"
            value={
              (medicalHistory?.heartDisease as Record<string, unknown>)?.present
            }
          />
        </View>
        <View style={baseStyles.gridItem}>
          <PDFField
            ...
            value={
              (medicalHistory?.heartDisease as Record<string, unknown>)?.details
            }
          />
        </View>
        <View style={baseStyles.gridItem}>
...
function GynecoObstetricHistorySection({ patient }: PIDPathologyPDFProps) {
  ...
  return (
    <View style={baseStyles.section}>
      ...
      <View style={baseStyles.grid}>
        <View style={baseStyles.gridItem}>
          <PDFField label="Ménarche" value={gynecoObstetricHistory?.menarche} />
        </View>
        <View style={baseStyles.gridItem}>
...
function LifestyleSection({ patient }: PIDPathologyPDFProps) {
  ...
  return (
    <View style={baseStyles.section}>
      ...
      {/* Contact aviaire */}
      {avianContact && Object.values(avianContact).some((v) => hasValue(v)) && (
        <>
          ...
          <View style={baseStyles.grid}>
            ...
            <View style={baseStyles.gridItemFull}>
              <PDFField label="Description" value={avianContact?.description} />
            </View>
          </View>
        </>
      )}
      ...
      {autoImmuneDisease &&
        Object.values(autoImmuneDisease).some((v) => hasValue(v)) && (
          <>
            ...
            <View style={baseStyles.grid}>
              <View style={baseStyles.gridItem}>
                <PDFField label="Présente" value={autoImmuneDisease?.present} />
              </View>
              <View style={baseStyles.gridItemFull}>
                <PDFField label="Détails" value={autoImmuneDisease?.details} />
              </View>
            </View>
          </>
        )}
        ...
        <>
          ...
          <View style={baseStyles.grid}>
            ...
            <View style={baseStyles.gridItem}>
              <PDFField
                label="Insomniante"
                value={(cough?.intensity as Record<string, unknown>)?.insomnia}
              />
            </View>
            <View style={baseStyles.gridItem}>
              <PDFField
            ...
            <View style={baseStyles.gridItem}>
              <PDFField
                ...
                value={(cough?.triggers as Record<string, unknown>)?.duringMeal}
              />
            </View>
            <View style={baseStyles.gridItem}>
              <PDFField
                label="Décubitus"
                value={(cough?.triggers as Record<string, unknown>)?.decubitus}
              />
            </View>
            <View style={baseStyles.gridItemFull}>
              <PDFField
      ...
      {dyspnea && Object.values(dyspnea).some((v) => hasValue(v)) && (
        <>
          ...
          <View style={baseStyles.grid}>
            ...
            <View style={baseStyles.gridItem}>
              <PDFField label="Stade de Sadoul" value={dyspnea?.sadoulStage} />
            </View>
            <View style={baseStyles.gridItem}>
            ...
            <View style={baseStyles.gridItem}>
              <PDFField
                label="Décubitus"
                value={
                  (dyspnea?.circumstances as Record<string, unknown>)?.decubitus
                }
              />
            </View>
            <View style={baseStyles.gridItemFull}>
        ...
        <>
          ...
          <View style={baseStyles.grid}>
            ...
            <View style={baseStyles.gridItem}>
              <PDFField
                label="Droit"
                value={(chestPain?.location as Record<string, unknown>)?.right}
              />
            </View>
            <View style={baseStyles.gridItem}>
              <PDFField
            ...
            <View style={baseStyles.gridItem}>
              <PDFField
                label="Oppression"
                value={(chestPain?.type as Record<string, unknown>)?.oppression}
              />
            </View>
            <View style={baseStyles.gridItem}>
              <PDFField
        ...
        Object.values(expectoration).some((v) => hasValue(v)) && (
          <>
            ...
            <View style={baseStyles.grid}>
              ...
              <View style={baseStyles.gridItem}>
                <PDFField label="Fréquence" value={expectoration?.frequency} />
              </View>
              <View style={baseStyles.gridItem}>
    ...
    <View style={baseStyles.section}>
      ...
      {neurologicalSigns &&
        Object.values(neurologicalSigns).some((v) => hasValue(v)) && (
          <>
            <Text style={baseStyles.subsectionTitle}>Signes neurologiques</Text>
            <View style={baseStyles.grid}>
              <View style={baseStyles.gridItem}>
                <PDFField label="Présents" value={neurologicalSigns?.present} />
              </View>
              <View style={baseStyles.gridItemFull}>
                <PDFField label="Détails" value={neurologicalSigns?.details} />
              </View>
            </View>
          </>
        )}
        ...
        <>
          ...
          <View style={baseStyles.grid}>
            ...
            <View style={baseStyles.gridItem}>
              <PDFField
                label="Chiffrée"
                value={(fever?.quantified as Record<string, unknown>)?.present}
              />
            </View>
            <View style={baseStyles.gridItem}>
              <PDFField
    ...
    <View style={baseStyles.section}>
      ...
      {pleuroPulmonaryExam &&
        Object.values(pleuroPulmonaryExam).some((v) => hasValue(v)) && (
          <>
            ...
            <View style={baseStyles.grid}>
              <View style={baseStyles.gridItem}>
                <PDFField label="Normal" value={pleuroPulmonaryExam?.normal} />
              </View>
            </View>
            <View style={baseStyles.grid}>
              <View style={baseStyles.gridItemFull}>
                <PDFField label="Inspection" value={clinicalExam?.inspection} />
              </View>
              <View style={baseStyles.gridItemFull}>
                <PDFField label="Palpation" value={clinicalExam?.palpation} />
              </View>
              <View style={baseStyles.gridItemFull}>
                <PDFField label="Percussion" value={clinicalExam?.percussion} />
              </View>
              <View style={baseStyles.gridItemFull}>
                <PDFField
                  label="Auscultation"
        ...
        Object.values(cardiovascularExam).some((v) => hasValue(v)) && (
          <>
            ...
            <View style={baseStyles.grid}>
              ...
              <View style={baseStyles.gridItemFull}>
                <PDFField label="Détails" value={cardiovascularExam?.details} />
              </View>
            </View>
          </>
        )}
      ...
      {neurologicalExam &&
        Object.values(neurologicalExam).some((v) => hasValue(v)) && (
          <>
            <Text style={baseStyles.subsectionTitle}>Examen neurologique</Text>
            <View style={baseStyles.grid}>
              <View style={baseStyles.gridItem}>
        ...
        Object.values(ophthalmologicExam).some((v) => hasValue(v)) && (
          <>
            ...
            <View style={baseStyles.grid}>
              ...
              <View style={baseStyles.gridItemFull}>
                <PDFField label="Détails" value={ophthalmologicExam?.details} />
              </View>
            </View>
          </>
        )}
  ...
  return (
    <View style={baseStyles.section}>
      ...
      {chestXRay && Object.values(chestXRay).some((v) => hasValue(v)) && (
        <>
          ...
          <View style={baseStyles.grid}>
            ...
            <View style={baseStyles.gridItem}>
              <PDFField label="Distribution" value={chestXRay?.distribution} />
            </View>
          </View>
      ...
      {handXRay && Object.values(handXRay).some((v) => hasValue(v)) && (
        <>
          <Text style={baseStyles.subsectionTitle}>Radiographie des mains</Text>
          <View style={baseStyles.grid}>
            <View style={baseStyles.gridItem}>
      ...
      {biology && Object.values(biology).some((v) => hasValue(v)) && (
        <>
              ...
              <View style={baseStyles.grid}>
                ...
                <View style={baseStyles.gridItem}>
                  <PDFField
                    ...
                    value={(biology.cbc as Record<string, unknown>)?.hemoglobin}
                  />
                </View>
                <View style={baseStyles.gridItem}>
                  <PDFField
                ...
                <View style={baseStyles.gridItem}>
                  <PDFField
                    ...
                    value={
                      (biology.cbc as Record<string, unknown>)?.whiteBloodCells
                    }
                  />
                </View>
                <View style={baseStyles.gridItem}>
                ...
                <View style={baseStyles.gridItem}>
                  <PDFField
                    label="Plaquettes (/mm³)"
                    value={(biology.cbc as Record<string, unknown>)?.platelets}
                  />
                </View>
              </View>
            </>
            ...
            <>
              ...
              <View style={baseStyles.grid}>
                ...
                <View style={baseStyles.gridItem}>
                  <PDFField
                    label="ANA"
                    value={(biology.immunology as Record<string, unknown>)?.ana}
                  />
                </View>
                <View style={baseStyles.gridItem}>
                  <PDFField
          ...
          {hasValue((biology as Record<string, unknown>)?.viralSerology) && (
            <>
              <Text style={baseStyles.subsectionTitle}>Sérologies virales</Text>
              <View style={baseStyles.grid}>
                <View style={baseStyles.gridItem}>
                  <PDFField
                    label="Effectuées"
      ...
      {/* Microbiologie */}
      {microbiology && Object.values(microbiology).some((v) => hasValue(v)) && (
        <>
          ...
          <View style={baseStyles.grid}>
            ...
            <View style={baseStyles.gridItemFull}>
              <PDFField label="Autres tests" value={microbiology?.otherTests} />
            </View>
          </View>
        </>
      )}
      ...
      {bronchoscopy && Object.values(bronchoscopy).some((v) => hasValue(v)) && (
        <>
          <Text style={baseStyles.subsectionTitle}>Fibroscopie bronchique</Text>
          <View style={baseStyles.grid}>
            <View style={baseStyles.gridItem}>
      ...
      {histology && Object.values(histology).some((v) => hasValue(v)) && (
        <>
          ...
          <View style={baseStyles.grid}>
            ...
            <View style={baseStyles.gridItemFull}>
              <PDFField label="Biopsie cutanée" value={histology?.skinBiopsy} />
            </View>
            <View style={baseStyles.gridItemFull}>
              <PDFField label="Autre biopsie" value={histology?.otherBiopsy} />
            </View>
          </View>
        </>
      )}
      ...
      {/* Phtisiologie */}
      {phthisiology && Object.values(phthisiology).some((v) => hasValue(v)) && (
        <>
      ...
      {functionalAssessment &&
        Object.values(functionalAssessment).some((v) => hasValue(v)) && (
          <>
            ...
            <View style={baseStyles.grid}>
              <View style={baseStyles.gridItem}>
                <PDFField label="Effectué" value={functionalAssessment?.done} />
              </View>
              <View style={baseStyles.gridItemFull}>
                <PDFField
                  label="EFR"
