      ...
      {hasToxicHistory && (
        <>
          ...
          <View style={baseStyles.grid}>
            ...
            <View style={baseStyles.gridItem}>
              <PDFField label="Paquet-années" value={toxicHistory?.packYears} />
            </View>
            <View style={baseStyles.gridItem}>
              <PDFField
      ...
      {hasPhysicalSigns && (
        <>
          ...
          <View style={baseStyles.grid}>
            ...
            <View style={baseStyles.gridItem}>
              <PDFField label="Crépitations" value={physicalSigns?.crackles} />
            </View>
          </View>
        </>
      )}
...
function EtiologySection({ patient }: DDBPathologyPDFProps) {
  ...
  return (
    <View style={baseStyles.section}>
      ...
      <View style={baseStyles.grid}>
        <View style={baseStyles.gridItemFull}>
          <PDFField label="DDB localisée" value={etiology?.localizedEtiology} />
        </View>
        <View style={baseStyles.gridItemFull}>
          <PDFField
