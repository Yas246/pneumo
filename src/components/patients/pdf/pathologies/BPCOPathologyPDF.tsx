...
function ConsultationReasonSection({ patient }: BPCOPathologyPDFProps) {
  ...
  return (
    <View style={baseStyles.section}>
      ...
      <View style={pathologyStyles.bpcoSection}>
          ...
          <>
            ...
            <View style={baseStyles.grid}>
              ...
              <View style={baseStyles.gridItem}>
                <PDFField
                  label="Pneumonies"
                  value={medicalHistory?.pneumonias}
                />
              </View>
              <View style={baseStyles.gridItem}>
                <PDFField
        ...
        {hasOtherMedicalHistory && (
          <>
            ...
            <View style={baseStyles.grid}>
              ...
              {hasValue(
                otherMedicalHistory?.connectiveTissueDiseaseDetails
              ) && (
                <View style={baseStyles.gridItemFull}>
                  <PDFField
          ...
          <>
            ...
            <View style={baseStyles.grid}>
              ...
              <View style={baseStyles.gridItem}>
                <PDFField
                  label="Pneumocoque"
                  value={vaccination?.pneumococcus}
                />
              </View>
              <View style={baseStyles.gridItem}>
          ...
          <>
            ...
            <View style={baseStyles.grid}>
              ...
              <View style={baseStyles.gridItem}>
                <PDFField
                  label="Température"
                  value={generalState?.temperature}
                />
              </View>
              <View style={baseStyles.gridItem}>
          ...
          <>
            ...
            <View style={baseStyles.grid}>
              ...
              <View style={baseStyles.gridItem}>
                <PDFField
                  label="Équilibre"
                  value={nervousSystem?.equilibrium}
                />
              </View>
      ...
      <View style={pathologyStyles.bpcoSection}>
        ...
        {hasDiagnosticTests && (
          <>
            ...
            {/* EFR / spirométrie */}
            {spirometry &&
              Object.values(spirometry).some((v) => hasValue(v)) && (
                <>
                  <Text style={baseStyles.subsectionTitle}>
                    EFR / Spirométrie
                  </Text>
                  <View style={baseStyles.grid}>
                    ...
                    <View style={baseStyles.gridItem}>
                      <PDFField
                        label="VEMS/CV (%)"
                        value={spirometry?.vemsCv}
                      />
                    </View>
                    <View style={baseStyles.gridItem}>
                      <PDFField
                        label="Stade GOLD"
                        value={spirometry?.goldStage}
                      />
                    </View>
                  </View>
                </>
                      ...
                      <View style={baseStyles.grid}>
                        ...
                        <View style={baseStyles.gridItem}>
                          <PDFField
                            label="VGM (fL)"
                            value={
                              (biology.cbc as Record<string, unknown>)?.mcv
                            }
                          />
                        </View>
                        <View style={baseStyles.gridItem}>
                      ...
                      <View style={baseStyles.grid}>
                        <View style={baseStyles.gridItem}>
                          <PDFField
                            ...
                            value={
                              (
                                chestCT.abnormalDetails as Record<
                                  string,
                                  unknown
                                >
                              )?.bronchialThickening
        ...
        {hasImpactAssessment && (
          <>
            ...
            {/* Autres examens */}
            {otherTests &&
              Object.values(otherTests).some((v) => hasValue(v)) && (
                <>
