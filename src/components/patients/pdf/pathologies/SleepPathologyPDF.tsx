    ...
    <View style={baseStyles.section}>
      ...
      {facialMorphology &&
        Object.values(facialMorphology).some((v) => hasValue(v)) && (
          <>
            <Text style={baseStyles.subsectionTitle}>Morphologie Faciale</Text>
            <View style={baseStyles.grid}>
              <View style={baseStyles.gridItem}>
                <PDFField
...
function ComplementaryExamsSection({ patient }: SleepPathologyPDFProps) {
  ...
  return (
    <View style={baseStyles.section}>
      <Text style={baseStyles.sectionTitle}>Examens Complementaires</Text>
      ...
      <View style={baseStyles.grid}>
        ...
        <View style={baseStyles.gridItem}>
          <PDFField label="Polysomnographie" value={complementaryExams?.psg} />
        </View>
        <View style={baseStyles.gridItem}>
          <PDFField
      ...
      {hasValue(complementaryExams?.polygraphyDate) && (
        <>
          <Text style={baseStyles.subsectionTitle}>Resultats Polygraphie</Text>
          <View style={baseStyles.grid}>
            <View style={baseStyles.gridItem}>
              <PDFField
                label="Date"
      ...
      {hasValue(complementaryExams?.gazometryDate) && (
        <>
          ...
          <View style={baseStyles.grid}>
            ...
            <View style={baseStyles.gridItem}>
              <PDFField label="PaO2 (mmHg)" value={complementaryExams?.pao2} />
            </View>
            <View style={baseStyles.gridItem}>
              <PDFField
                label="PaCO2 (mmHg)"
...
function DiagnosisSection({ patient }: SleepPathologyPDFProps) {
  ...
  return (
    <View style={baseStyles.section}>
      ...
      <Text style={baseStyles.subsectionTitle}>Pathologies Diagnostiquees</Text>
      <View style={baseStyles.grid}>
        <View style={baseStyles.gridItem}>
      ...
      {pathologies && pathologies.length > 0 && (
        <>
          <Text style={baseStyles.subsectionTitle}>Pathologies Associees</Text>
    ...
    <View style={baseStyles.section}>
      ...
      {medicalTreatments &&
        Object.values(medicalTreatments).some((v) => hasValue(v)) && (
          <>
            <Text style={baseStyles.subsectionTitle}>Traitements Medicaux</Text>
            <View style={baseStyles.grid}>
              <View style={baseStyles.gridItem}>
      ...
      {exitPrescription &&
        Object.values(exitPrescription).some((v) => hasValue(v)) && (
          <>
            <Text style={baseStyles.subsectionTitle}>Ordonnance de Sortie</Text>
            <View style={baseStyles.gridItemFull}>
  ...
  return (
    <View style={baseStyles.section}>
      ...
      <View style={baseStyles.grid}>
        ...
        <View style={baseStyles.gridItem}>
          <PDFField label="Numero de serie" value={ppcFollowUp?.serialNumber} />
        </View>
      </View>
      <View style={baseStyles.gridItemFull}>
        <PDFField
