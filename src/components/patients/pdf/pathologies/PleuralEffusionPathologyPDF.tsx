      ...
      {hasPleurisyHistory && (
        <>
          ...
          <View style={baseStyles.grid}>
            ...
            <View style={baseStyles.gridItem}>
              <PDFField label="Diagnostic" value={pleurisyHistory?.diagnosis} />
            </View>
            <View style={baseStyles.gridItem}>
              <PDFField label="Traitement" value={pleurisyHistory?.treatment} />
            </View>
            <View style={baseStyles.gridItemFull}>
              <PDFField label="Évolution" value={pleurisyHistory?.evolution} />
            </View>
          </View>
        </>
      )}
  ...
  return (
    <View style={baseStyles.section}>
      ...
      <View style={baseStyles.grid}>
        ...
        <View style={baseStyles.gridItem}>
          <PDFField label="Type toux" value={pleuralClinicalExam?.coughType} />
        </View>
        <View style={baseStyles.gridItem}>
          <PDFField
            label="Expectoration"
      ...
      {/* Signes Généraux */}
      {generalSigns && Object.values(generalSigns).some((v) => hasValue(v)) && (
        <>
      ...
      <View style={baseStyles.grid}>
        ...
        <View style={baseStyles.gridItem}>
          <PDFField label="Ganglions" value={pleuralClinicalExam?.lymphNodes} />
        </View>
        <View style={baseStyles.gridItem}>
          <PDFField
...
function PleuralPunctureSection({ patient }: PleuralEffusionPathologyPDFProps) {
  ...
  return (
    <View style={baseStyles.section}>
      ...
      {/* Biochimie */}
      {biochemistry && Object.values(biochemistry).some((v) => hasValue(v)) && (
        <>
          ...
          <View style={baseStyles.grid}>
            ...
            <View style={baseStyles.gridItem}>
              <PDFField label="Glucose (g/L)" value={biochemistry?.glucose} />
            </View>
            <View style={baseStyles.gridItemFull}>
      ...
      {cytology && Object.values(cytology).some((v) => hasValue(v)) && (
        <>
          ...
          <View style={baseStyles.grid}>
            ...
            <View style={baseStyles.gridItem}>
              <PDFField label="Lymphocytes (%)" value={cytology?.lymphocytes} />
            </View>
            <View style={baseStyles.gridItem}>
              <PDFField
  ...
  return (
    <View style={baseStyles.section}>
      ...
      <View style={baseStyles.grid}>
        ...
        <View style={baseStyles.gridItem}>
          <PDFField label="Cancer primitif" value={diagnosis?.primaryCancer} />
        </View>
        <View style={baseStyles.gridItemFull}>
          <PDFField
      ...
      {outcome && Object.values(outcome).some((v) => hasValue(v)) && (
        <>
          ...
          <View style={baseStyles.grid}>
            ...
            <View style={baseStyles.gridItem}>
              <PDFField label="Pachypleurite" value={outcome?.pachypleuritis} />
            </View>
            <View style={baseStyles.gridItem}>
              <PDFField label="Récidive" value={outcome?.recurrence} />
            </View>
            <View style={baseStyles.gridItem}>
              <PDFField label="Perdu de vue" value={outcome?.lostToFollowUp} />
            </View>
            <View style={baseStyles.gridItem}>
